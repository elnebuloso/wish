...
run="docker run --tty --interactive --rm --user $(id -u) --workdir $(pwd) --volume $(pwd):$(pwd) --env-file /tmp/env ${WISH_PHING_DOCKER_IMAGE}:${WISH_PHING_DOCKER_IMAGE_TAG} ${WISH_PHING_DOCKER_IMAGE_CMD} $@"
